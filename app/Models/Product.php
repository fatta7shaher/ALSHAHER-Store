...
class Product extends Model
{
    ...
    protected $fillable = [
        'name', 'description', 'slug', 'image', 'category_id', 'store_id', 'price', 'compare_price', 'status'
    ];

    // الحقول يلي ما بدك تظهرها بال json api
    protected $hidden = [
        'image',
    ...
    {
        if (!$this->image) {
            return 'https://www.scusd.edu/sites/main/files/imagecache/carousel/main-images/camera_lense_0.jpeg';
        }
